...
import {
  ...
  getDownloadURL,
  uploadBytes,
} from "firebase/storage"; // Import storage module
...
const Userprofile = ({ navigation }) => {
  ...
  const handleUploadPicture = async () => {
    try {
      ...
      const storageReference = storageRef(
        storage,
        `profile-pictures/${auth.currentUser.uid}/profile-picture.jpg`
      );
  ...
  const handleChangePassword = async () => {
    try {
      ...
      if (error.code === "auth/too-many-requests") {
        setErrorMessage(
          "Too many requests. Please wait for one minute before trying again."
        );
  ...
  return (
    <ImageBackground
      source={require("./assets/2ndBI.png")}
      ...
      <View style={styles.container}>
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("Online Banking")}
              style={styles.sidebarItem}
            >
              <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              ...
              style={[styles.sidebarItem, { marginBottom: 20 }]}
            >
              <View style={styles.buttonContainer}>
