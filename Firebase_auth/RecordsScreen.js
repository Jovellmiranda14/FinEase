...
try {
  ...
  // Use set to save the new record under a unique key (auto-generated by Firebase)
  const newRecordRef = push(userRecordsRef); // This generates a new child location with a unique key
  await set(newRecordRef, newRecord); // Set the value of the new child location to the newRecord

  // Update local state with the new record (include the generated key)
  setRecords([...records, { ...newRecord, id: newRecordRef.key }]);
